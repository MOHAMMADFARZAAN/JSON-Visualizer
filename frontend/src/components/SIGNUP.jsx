...
const Signup = ({ loginOpen, setLoginOpen }) => {
    ...
    return (
        <div
            className="w-full max-w-md flex flex-col p-5 border border-neutral-400 items-center h-[67vh] rounded-xl bg-[#171717] duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0"
        >
